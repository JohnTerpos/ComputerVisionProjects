...
if __name__ == '__main__':
    ...
    u5 = keras.layers.concatenate([u5, conv3])
    ...
    model_name = 'C:/Users/user/PycharmProjects/ExercisesComputerVision/Exercise2/Semantic_segmentation_dataset/finalSegCNN.h5'
