...
filename = "C:/Users/user/PycharmProjects/ExercisesComputerVision/Exercise2/Semantic_segmentation_dataset/ComparativeResultsExercise2_2.xlsx"
Model2LoadFullName = ['C:/Users/user/PycharmProjects/ExercisesComputerVision/Exercise2/Semantic_segmentation_dataset/finalSegCNN.h5']
Where2Look4Images = 'C:/Users/user/PycharmProjects/ExercisesComputerVision/Exercise2/Semantic_segmentation_dataset/input'
Where2Look4Masks = 'C:/Users/user/PycharmProjects/ExercisesComputerVision/Exercise2/Semantic_segmentation_dataset/output'
Where2SaveTheResults = 'C:/Users/user/PycharmProjects/ExercisesComputerVision/Exercise2/Semantic_segmentation_dataset/Satelite Models outcomes/'
...
for ModelIdx in range(0, len(ModelsNames)):
    ...
    print(' Running some tests using the', ModelsNames[ModelIdx])
    ...
    for imageSetIdx in range(0, len(Sets2RunTheModels)):
        ...
        for imgIdx in range(0, len(SubcategoryFiles)):
            #fix the full names
            ...
            #CAREFUL: resize really change values. Convert them to binary 0, 1 after you do resize
